...
function [cell_front,cell_end,k,Ve,rawData,meanVi,stdVi,nextFID] = catchVehs3(data,firstFID,WinLowerB,WinUperB)
	...
	%a1 = -128.4;%i80-2
	%a2 = 13.33;
    %sdPara =[50,15.6946188969802,114.313208506104,2.21680315505852,9.98014217655979];%i80-2
    sdPara =[50.0000195382319,15.0389094348141,101.598158072210,2.18097279741402,6.83666847188233];%enhanced_i80-2
